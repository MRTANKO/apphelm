...
helm.sh/chart: {{ include "java-app-chart.chart" . }}
...
*/}}
{{- define "java-app-chart.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "java-app-chart.fullname" .) .Values.serviceAccount.name }}
{{- else }}
